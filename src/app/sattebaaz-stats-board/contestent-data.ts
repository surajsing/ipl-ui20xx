    ...
    public contestants : Contestant [] = [
        {
            ...
            currentHoldingValue: '142.91 INR'
        },
        {
            sequence : 2,
            name: {
            ...
            currentHoldingLabel: 'Current Holding Value',
            currentHoldingValue: '141.25 INR'
        },
        {
            sequence : 3,
            name: {
            ...
            role: 'Sattebaaz',
            currentHoldingLabel: 'Current Holding Value',
            currentHoldingValue: '189.58 INR'
        },
        {
            sequence : 4,
            name: {
        ...
        },
        {
            ...
            role: 'Sattebaaz',
            currentHoldingLabel: 'Current Holding Value',
            currentHoldingValue: '-103.34 INR'
        },
        {
            sequence : 11,
            name: {
