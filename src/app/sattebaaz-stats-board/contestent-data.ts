    ...
    public contestants : Contestant [] = [
        {
            ...
            currentHoldingValue: '152.91 INR'
        },
        {
            sequence : 2,
            name: {
